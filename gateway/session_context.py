...
_CRON_SCRIPT: ContextVar = ContextVar("HERMES_CRON_SCRIPT", default=_UNSET)
_CRON_SCRIPT_SHA256: ContextVar = ContextVar("HERMES_CRON_SCRIPT_SHA256", default=_UNSET)
...
_VAR_MAP = {
    ...
    "HERMES_CRON_SCRIPT": _CRON_SCRIPT,
    "HERMES_CRON_SCRIPT_SHA256": _CRON_SCRIPT_SHA256,
}
